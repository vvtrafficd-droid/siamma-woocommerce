...
export const allowedDeliveryPostalCodes = [
  "4835-517",
  "4700-001",
  "4760-001",
  "4750-001",
...
export const isAllowedDeliveryPostalCode = (postalCode: string): boolean => {
  if (!isValidPostalCode(postalCode)) return false;
  return allowedDeliveryPostalCodes.includes(postalCode);
};
