  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
      ...
      <div>
        ...
        {/* ✅ Add to Cart */}
        {selectedVariation?.stock_status === "instock" ? <AddToCartVariation product={product} variation={selectedVariation} /> : <Button className="bg-gray-300 border-gray-400 border px-5 py-2" disabled>Esgotado</Button>}


        <div className="mt-10 text-gray-500 text-md space-y-2">
          <div className="">
            SKU: {selectedVariation?.sku || product.sku || 'N/D'}
          </div>
          {/* ✅ Categories */}
